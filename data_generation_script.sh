...
#           self_instruct_descriptions_fewshot_75_gpt-4_temp0.70_maxtokens1024_rng[0-9]_used_concepts.jsonl
for rng_offset in {0..9}; do python description_prompt.py --batch_request --model gpt-4 --num_generations 10 --max_tokens 1024 --batch_size 10 --num_descriptions 75 --rng_offset $rng_offset; done

# Wait until it's done...
# ...move everything into the generated_descriptions directory, to keep stuff clean
mkdir -p generated_descriptions
mv self_instruct_descriptions_fewshot_75_gpt-4_temp0.70_maxtokens1024_rng*_used_concepts.jsonl generated_descriptions/
