...
class Color:
    ...
    Color.BLACK, Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW, Color.GREY, Color.PINK, Color.ORANGE, Color.PURPLE, Color.BROWN
...
def bounding_box(grid, background=Color.BLACK):
    ...
    PURPLE_object = [ obj for obj in objects if np.any(obj == Color.PURPLE) ][0]
    PURPLE_x, PURPLE_y, PURPLE_w, PURPLE_h = bounding_box(PURPLE_object)
    """
    n, m = grid.shape
    x_min, x_max = n, -1
    y_min, y_max = m, -1
